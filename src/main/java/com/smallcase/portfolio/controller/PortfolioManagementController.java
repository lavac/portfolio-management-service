...
public class PortfolioManagementController {
  ...
  public ResponseEntity<TradeModel> addTrade(@PathVariable @Valid @NonNull Integer portFolioId,
                                             @PathVariable @Valid @NonNull String tickerSymbol,
                                             @RequestBody @Valid TradeCreateRequest tradeCreateRequest) {
    return ResponseEntity
        .accepted()
        .body(tradeService.add(portFolioId, tickerSymbol, tradeCreateRequest));
  }
  ...
  public ResponseEntity<TradeModel> updateTrade(@PathVariable  @Valid @NonNull Integer tradeId,
